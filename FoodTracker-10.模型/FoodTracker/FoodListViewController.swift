...
class FoodListViewController: UITableViewController {
    ...
    func loadFoods() -> [FoodItem]? {
        return NSKeyedUnarchiver.unarchiveObjectWithFile(FoodItem.ArchiveURL.path!) as? [FoodItem]
    }
    ...
    func loadDefaultFoods(){
        foods.append(FoodItem(name: "egg", photo: nil)!)
        foods.append(FoodItem(name: "fish", photo: nil)!)
